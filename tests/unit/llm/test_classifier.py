...
class TestClassificationResult:
    ...
    def test_from_llm_response_json(self):
        ...
        result = ClassificationResult.from_llm_response(json_response, "osimertinib")
    ...
    def test_from_llm_response_text(self):
        ...
        result = ClassificationResult.from_llm_response(text_response, "test_drug")
    ...
    def test_from_llm_response_fallback(self):
        ...
        result = ClassificationResult.from_llm_response(bad_response, "test_drug")
...
class TestBatchClassificationResult:
    ...
    def test_batch_result_creation(self):
        ...
        batch_result = BatchClassificationResult(
            classifications={"class_a": ["drug1", "drug2"], "class_b": ["drug3"]},
            unclassified=["drug4"],
            total=4,
            classified_count=3,
...
class TestMedicationClassifier:
    ...
    def classifier(self, mock_service):
        ...
        return MedicationClassifier(
            llm_service=mock_service, disease_module="nsclc", min_confidence=0.5
        )
    ...
    async def test_validate_medication(self, classifier):
        ...
        is_valid, standard_name, confidence = await classifier.validate_medication(
            "pembro"
        )
    ...
    async def test_augment_medication_info(self, classifier):
        ...
        info = await classifier.augment_medication_info(
            "pembrolizumab", drug_class="immunotherapy"
        )

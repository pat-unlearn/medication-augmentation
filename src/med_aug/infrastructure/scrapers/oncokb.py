...
class OncoKBScraper(BaseScraper):
    ...
    async def scrape_medication_info(self, medication_name: str) -> ScraperResult:
        ...
        try:
            ...
            data = {
                ...
                'resistance_mechanisms': self._get_resistance_mechanisms(medication_name),
            ...
            logger.error("oncokb_scrape_failed", medication=medication_name, error=str(e))
            return ScraperResult(
                success=False,
                data={},
    ...
    async def get_biomarker_summary(self, gene: str) -> Dict[str, Any]:
        ...
        try:
            biomarker_data = {
                ...
                'ALK': {
                    ...
                    'targeted_therapies': [
                        ...
                        'crizotinib', 'ceritinib', 'ensartinib'
                    ],
            ...
            return biomarker_data.get(gene.upper(), {
                'error': f'Biomarker {gene} not found in database'
            })

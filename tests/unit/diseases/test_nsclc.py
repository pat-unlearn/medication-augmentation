...
class TestNSCLCModule:
    ...
    def test_chemotherapy_keywords(self, nsclc_module):
        ...
        chemo_class = next(
            dc for dc in nsclc_module.drug_classes if dc.name == "chemotherapy"
        )
    ...
    def test_immunotherapy_keywords(self, nsclc_module):
        ...
        immuno_class = next(
            dc for dc in nsclc_module.drug_classes if dc.name == "immunotherapy"
        )
    ...
    def test_targeted_therapy_keywords(self, nsclc_module):
        ...
        targeted_class = next(
            dc for dc in nsclc_module.drug_classes if dc.name == "targeted_therapy"
        )
    ...
    def test_validate_medication_chemotherapy(self, nsclc_module):
        ...
        assert (
            nsclc_module.validate_medication("Carboplatin", "chemotherapy") is True
        )  # Case insensitive
        ...
        assert (
            nsclc_module.validate_medication("pembrolizumab", "chemotherapy") is False
        )
    ...
    def test_validate_medication_immunotherapy(self, nsclc_module):
        ...
        assert (
            nsclc_module.validate_medication("pembrolizumab", "immunotherapy") is True
        )
    ...
    def test_validate_medication_targeted_therapy(self, nsclc_module):
        ...
        assert (
            nsclc_module.validate_medication("osimertinib", "targeted_therapy") is True
        )
    ...
    def test_validate_medication_unknown_drug(self, nsclc_module):
        ...
        result = nsclc_module.validate_medication(
            "experimental_drug_xyz", "chemotherapy"
        )
        assert result is False  # Not permissive for known classes

        # For unknown drug classes, should be permissive
        result_unknown = nsclc_module.validate_medication(
            "experimental_drug_xyz", "unknown_class"
        )
    ...
    def test_overlapping_drugs_in_classes(self, nsclc_module):
        ...
        alk_class = next(
            dc for dc in nsclc_module.drug_classes if dc.name == "alk_inhibitors"
        )
        ros1_class = next(
            dc for dc in nsclc_module.drug_classes if dc.name == "ros1_inhibitors"
        )

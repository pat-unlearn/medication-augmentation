...
class TestPromptTemplate:
    ...
    def test_template_safe_substitute(self):
        ...
        template = PromptTemplate(
            name="test", system="System", user_template="$provided and $missing"
        )
...
class TestMedicationPrompts:
    ...
    def test_augmentation_prompt(self):
        ...
        system, prompt = template.format(
            medication="osimertinib", disease="NSCLC", drug_class="targeted_therapy"
        )
    ...
    def test_extraction_enhancement_prompt(self):
        ...
        system, prompt = template.format(text="Patient on pembro 200mg and carbo/taxol")
...
class TestPromptManager:
    ...
    def test_add_custom_template(self):
        ...
        custom_template = PromptTemplate(
            name="custom", system="Custom system", user_template="Custom prompt: $param"
        )

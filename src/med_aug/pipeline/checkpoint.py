...
class CheckpointManager:
    ...
    def __init__(self, checkpoint_dir: Optional[Path] = None):
        ...
        logger.info("checkpoint_manager_initialized", directory=str(self.checkpoint_dir))
    ...
    def load_checkpoint(self, pipeline_id: str, latest: bool = True) -> Optional[PipelineCheckpoint]:
        """
    ...
    def delete_checkpoint(self, pipeline_id: str, timestamp: Optional[str] = None) -> bool:
        """
        Delete checkpoint(s).
        ...
        for file in self.checkpoint_dir.glob("*.json"):
            if file.stat().st_mtime < cutoff_time:
                try:
                    ...
                    logger.error("checkpoint_cleanup_failed", file=str(file), error=str(e))

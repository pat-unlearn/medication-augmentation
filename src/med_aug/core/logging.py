...
class AuditLogger:
    ...
    def log_data_access(self, resource: str, action: str, user: Optional[str] = None, **details):
        """
    ...
    def log_modification(self, resource: str, before: Any, after: Any, user: Optional[str] = None, **details):
        """

...
class ResponseCache:
    ...
    def set(self, prompt: str, system: Optional[str], response: LLMResponse, **kwargs):
        """
...
class LLMService:
        ...
        **kwargs,
        ...
        for attempt in range(self.config.retry_attempts):
            try:
                ...
                logger.warning(
                    "llm_generation_failed", attempt=attempt + 1, error=str(e)
                )
    ...
    async def generate_with_template(
        self, template_name: str, use_cache: bool = True, **template_params
    ) -> LLMResponse:
        """
        ...
        Returns:
            LLM response
        """
        system, prompt = self.prompt_manager.format_prompt(

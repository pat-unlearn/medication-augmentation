...
class TestDiseaseRegistry:
    ...
    def test_discover_modules_success(self, mock_import, mock_iter_modules, empty_registry):
        """Test successful module discovery."""
        # Mock pkgutil to find a module
        mock_iter_modules.return_value = [
            (None, 'test_disease', True)  # ispkg=True
        ]
    ...
    @patch('med_aug.diseases.pkgutil.iter_modules')
    @patch('med_aug.diseases.importlib.import_module')
    def test_discover_modules_handles_import_error(self, mock_import, mock_iter_modules, empty_registry):
    ...
    @patch('med_aug.diseases.pkgutil.iter_modules')
    @patch('med_aug.diseases.importlib.import_module')
    def test_discover_modules_validates_module_class(self, mock_import, mock_iter_modules, empty_registry):
        """Test that discovery validates MODULE_CLASS is a DiseaseModule."""
        mock_iter_modules.return_value = [
            (None, 'invalid_module', True)
        ]

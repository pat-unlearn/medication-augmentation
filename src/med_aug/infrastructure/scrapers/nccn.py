...
class NCCNScraper(BaseScraper):
    ...
    def _get_treatment_lines(self, medication_name: str) -> Dict[str, List[str]]:
        ...
        first_line_drugs = [
            'pembrolizumab', 'osimertinib', 'alectinib', 'brigatinib',
            'ceritinib', 'crizotinib', 'sotorasib', 'adagrasib'
        ]
    ...
    def _is_biomarker_driven(self, medication_name: str) -> Dict[str, Any]:
        ...
        biomarker_map = {
            'osimertinib': {'biomarker': 'EGFR', 'mutations': ['exon 19 del', 'L858R', 'T790M']},
            'erlotinib': {'biomarker': 'EGFR', 'mutations': ['exon 19 del', 'L858R']},
            'afatinib': {'biomarker': 'EGFR', 'mutations': ['exon 19 del', 'L858R', 'uncommon']},
            ...
            'lorlatinib': {'biomarker': 'ALK', 'mutations': ['ALK fusion', 'ALK resistance']},
            ...
            'trastuzumab deruxtecan': {'biomarker': 'HER2', 'mutations': ['HER2 mutation']}
        }
    ...
    async def get_treatment_algorithm(self, histology: str, biomarkers: Dict[str, Any]) -> Dict[str, Any]:
        """

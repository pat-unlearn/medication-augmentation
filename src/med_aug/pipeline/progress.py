...
class ProgressTracker:
    ...
    def _create_layout(self) -> Layout:
        ...
        for phase_name, progress in self.report.phase_progress.items():
            ...
            progress_str = f"{progress.progress_percent:.0f}%" if progress.status == PhaseStatus.RUNNING else "-"
    ...
    def print_summary(self):
        ...
        console.print(f"Phases: {self.report.completed_phases}/{self.report.total_phases} completed")
